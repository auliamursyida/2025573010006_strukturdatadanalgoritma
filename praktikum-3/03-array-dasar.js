...
console.log('\n==== Latihan 3 ===');
const daftarBelanja = ['Beras', 'Gula', 'Minyak', 'Telur', 'Garam'];
...
console.log('\nSetelah di tambah:', daftarBelanja);

const itemDihapus = daftarBelanja.shift();
console.log('\nItem yang dihapus:', itemDihapus);
console.log('Daftar sekarang:', daftarBelanja,);

const cekSusu = daftarBelanja.includes('Susu');
if (cekSusu) {
